...
def run_arbitrage_detection(
    ...
    console.print(f"Analyzing market with {num_currencies} currencies and {num_transactions} exchange rates\n")
    ...
    is_valid, nx_has_cycle, our_cycle, our_has_arbitrage, cycles_agree = validate_bellman_ford_with_library(edges, num_currencies)
